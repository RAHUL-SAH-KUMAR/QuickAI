...
const GenerateImages = () => {
  ...
  return (
    <div className="h-full overflow-y-auto p-6 flex flex-col md:flex-row gap-4 text-slate-700">
      {/* Left Column: Input Form */}
      <form
        onSubmit={onSubmitHandler}
        className="w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200 flex-shrink-0"
      >
        ...
        <textarea
          ...
          rows={4}
          className="w-full p-2 mt-2 outline-none text-sm rounded-md border border-gray-300 resize-none"
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200 min-h-[24rem] flex flex-col">
